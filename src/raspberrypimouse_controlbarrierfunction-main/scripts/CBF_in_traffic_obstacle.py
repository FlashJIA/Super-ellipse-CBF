...
if __name__ == '__main__':
    try:
        ...
        # x_goal = np.array([[-2, -2, 2, 2, -0.25, -0.75, 0.75, 0.25, -2, -2, 2, 2, 0.25,0.75,-0.75,-0.25], 
        #                    [0.75, 0.25, -0.25, -0.75, -2, -2, 2, 2,-0.25, -0.75,0.25,0.75,-2,-2,2,2]])
        # {4, 5, 6, 7}    {0, 1, 2, 3}
        ...
        while not rospy.is_shutdown():
            ...
            dxi = si_barrier_cert(dxi, pose_si, np.transpose(np.array([[0.1, -0.07]])))
