...
def callSolve(Ox,Oy,Px,Py):
    ...
    def func(x):
        return ((((Px-Ox)*x))/1)**4 + ((((Py-Oy)*x))/1.45)**4 - 1
        # return ((((Px-Ox)*x))/0.6)**4 + ((((Py-Oy)*x))/1)**4 - 1
...
def si_barrier_cert(dxi, x, obstacles, barrier_gain=80, safety_radius=0.01, magnitude_limit=0.5):
